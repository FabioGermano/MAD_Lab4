...
public class BasicInfo {
    ...
    private ArrayList<String> typesOfServices; // take away, restaurant (numero posti) o entrambe


    public BasicInfo(String address, String phone,String email, String description, String logoThumb,  ArrayList<String> timeTable, ArrayList<String> typesOfServices){
